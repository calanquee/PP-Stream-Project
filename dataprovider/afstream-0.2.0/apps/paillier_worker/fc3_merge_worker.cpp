...
int main(int argc, char* argv[]) {
    ...
    afs::Worker<struct VectorItem, struct VectorItem, afs::NullClass, afs::NullClass>* worker =
        new afs::Worker<struct VectorItem, struct VectorItem, afs::NullClass, afs::NullClass>(std::string(worker_name), worker_id, std::string(""), num_compute_thread);
    ...
    */
    ...
    if(num_in){
        ...
        new afs::UpThreadNet<struct VectorItem, afs::NullClass>(num_in, num_compute_thread,0);
